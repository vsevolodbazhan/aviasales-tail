...
Будем читать файл по байтам начиная с конца и складывать байты в буфер. Как только встретим байт, значение которого является окончанием строки, зафиксируем текущее значение буфера, положив его в стэк. Сбросим буфер.
...
«Встанем» в конец файла и будем читать строки в бесконечном цикле.
